...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {/* Chat popup */}
      {isOpen && (
        <div className="animate-fade-in-up bg-card border border-border/60 rounded-2xl shadow-2xl w-[320px] overflow-hidden">
          {/* Header */}
      ...
      <button
        ...
        className="whatsapp-pulse h-14 w-14 rounded-full bg-[#25D366] hover:bg-[#20BD5A] text-white flex items-center justify-center shadow-lg hover:shadow-xl transition-all hover:scale-110"
